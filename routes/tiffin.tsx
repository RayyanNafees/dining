...
export default function Home() {
  ...
  return (
    <main class="overflow-hidden relative w-full min-h-screen max-h-screen text-white bg-slate-800">
      <header class="flex absolute top-0 justify-between items-center px-3 py-1 w-full bg-slate-700">
        <div class="flex gap-2 justify-start items-center">
          <Icon icon="mdi:menu" className="w-6 h-6" color="#171b26" />
          <div>
        ...
        <div class="flex overflow-y-scroll gap-2 items-center">
          <Icon icon="mdi:bell-outline" className="w-6 h-6" color="#171b26" />
          <Icon
